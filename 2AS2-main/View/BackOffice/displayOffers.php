...
if (!isset($offers) || empty($offers)) {
    ...
    foreach ($offers as $offer) { ?>
        <tr>
            ...
            <td>
                <form action="delete_offer.php" method="GET" style="display: inline;">
            ...
            <td>
                <form action="edit_offer.php" method="GET" style="display: inline ;" >
                    <input type="hidden" name="Title" value="<?php echo htmlspecialchars($offer['Title']); ?>">
                    <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir modifier cette offre ?');">modifier</button>
                </form>
            </td>

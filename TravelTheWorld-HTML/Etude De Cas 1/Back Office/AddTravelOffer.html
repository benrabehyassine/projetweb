                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <form id="addTravelOfferForm">
                                                ...
                                                <span id="title-error" class="error-message" style="color: red;"></span>
                                                <br>
                                            
                                                <label for="destination">Destination:</label><br>
                                                <input class="form-control form-control-user" type="text" id="destination" name="destination">
                                                <span id="destination-error" class="error-message" style="color: red;"></span>
                                                <br>
                                            
                                                <label for="departure_date">Departure Date:</label><br>
                                                <input class="form-control form-control-user" type="date" id="departure_date" name="departure_date">
                                                <span id="departure_date-error" class="error-message" style="color: red;"></span>
                                                <br>
                                            
                                                <label for="return_date">Return Date:</label><br>
                                                <input class="form-control form-control-user" type="date" id="return_date" name="return_date">
                                                <span id="return_date-error" class="error-message" style="color: red;"></span>
                                                <br>
                                            
                                                <label for="price">Price:</label><br>
                                                <input class="form-control form-control-user" type="number" id="price" name="price">
                                                <span id="price-error" class="error-message" style="color: red;"></span>
                                                <br>
                                            
                                                <div class="forms-group">
                                                    <div class="custom-control custom-checkbox small">
                                                        <input type="checkbox" class="custom-control-input" id="customCheck">
                                                        <label class="custom-control-label" for="customCheck">Availability</label>
                                                    </div>
                                                </div>
